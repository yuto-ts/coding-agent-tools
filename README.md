...
- Tools under `claude-code/plugins/` are also installable as Claude Code plugins: this repository doubles as a marketplace via [`.claude-plugin/marketplace.json`](./.claude-plugin/marketplace.json).
